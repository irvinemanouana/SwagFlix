...
//  SwagFlix
//
//  Created by Manouana on 19/10/2016.
...
class FavorisTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        favShows = dataHelper.getAllTvShows()
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // Configure the cell...
        cell.titleShow.text = favShows?[indexPath.row].title_show
        //cell.titleShow.adjustsFontSizeToFitWidth = true
        cell.descriptionShow.text = favShows?[indexPath.row].description_show
        cell.imageShow.loadImageFromUrl((favShows?[indexPath.row].picture_show)!)
